      ...
      <main className="container mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Agent Control</h1>
        ...
        {currentRoom && (
          <div className="mb-8 bg-white rounded-lg shadow-md p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Agent Test Interface</h2>
            ...
            <div className="space-y-4">
              ...
              {testMode === "voice" ? (
                <div className="border rounded-lg p-4 bg-gray-50">
                  <h3 className="font-medium mb-3">Voice Communication Test</h3>
                ...
                <div className="border rounded-lg p-4 bg-gray-50">
                  <h3 className="font-medium mb-3">Chat Communication Test</h3>
                  <div className="space-y-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <h3 className="text-lg font-medium mb-4">Test Call</h3>
                <div className="flex items-center space-x-4">
                  <Input
